  ...
  test("POST /reminders", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        triggerTime: CREATE_RESULT.triggerTime.toISOString(),
      ...
      .expect([
        {
          ...
          triggerTime: FIND_MANY_RESULT[0].triggerTime.toISOString(),
  ...
  test("GET /reminders/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        triggerTime: FIND_ONE_RESULT.triggerTime.toISOString(),
